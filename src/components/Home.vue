        ...
        <div class="column">
          <div class="card">
            <div class="card-content">
              <p class="subtitle">This product is amazing. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore!</p>
              <p class="name">- Joe Schmo</p>
            </div>
          </div>
        </div>
        <div class="column">
